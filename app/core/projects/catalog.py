...
_PROJECTS: tuple[ProjectSpec, ...] = (
    ...
    _spec(
        ...
        ("Power BI", "Pandas", "Dashboard"), "sales_performance",
    ...
    _spec(
        ...
        ("SQL", "Python", "Power BI"), "ecommerce_conversion",
    ...
    _spec(
        ...
        ("Google Analytics", "Power BI", "Python"), "ecommerce_conversion",
    ...
    _spec(
        ...
        ("SQL", "Power BI", "Operations"), "operations",

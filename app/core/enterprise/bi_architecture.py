...
_DOMAINS: tuple[dict[str, Any], ...] = (
    {
        ...
        "name": "SQL",
        "status": "implemented",
        "implemented": ["read-only SQL workbench", "joins", "CTEs", "subqueries", "aggregates", "window functions", "query-plan inspection", "20-question benchmark"],
    ...
    },
    {
        ...
        "implemented": ["star-schema PBIP generation", "grain contract", "fact/dimension tables", "one-direction relationships", "date dimension"],
        "generated": ["snowflake decision rule", "surrogate keys", "SCD Type 2", "role-playing dimensions", "bridge and many-to-many patterns", "degenerate dimensions"],
    ...
    },
    {
        ...
        "name": "DAX",
        "status": "generated_template",
        "implemented": ["explicit measures", "CALCULATE", "time intelligence", "ranking", "fail-closed RLS expression"],
        "generated": ["iterators", "virtual tables", "dynamic measure selector", "disconnected tables", "calculation-group script", "context and optimization notes"],
    ...
    },
    {
        ...
        "name": "Power Query / M",
        "status": "generated_template",
        "implemented": ["typed source query", "text cleaning", "blank-row removal", "duplicate removal"],
        "generated": ["RangeStart/RangeEnd parameters", "parameterized function", "query-folding boundary", "retry/error record", "incremental-refresh policy"],
